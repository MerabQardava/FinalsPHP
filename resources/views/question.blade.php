<x-app-layout>
    <div class="container mt-4">
        <form id="quizForm">
            ...
            @foreach($quiz->questions()->orderBy('order')->get() as $index => $question)
                <div class="card mb-3 question-card" id="question_card_{{ $index }}" data-index="{{ $index }}" style="{{ $index > 0 ? 'display:none;' : '' }}">
                    ...
                    <div class="card-body">
                        <img src="{{ asset($question->photo) }}" class="img-fluid mb-3" alt="Question Image">
                        ...
                        <div class="mt-3">
                            ...
                            @else
                                <button type="button" id="final" class="btn btn-success mt-2 next-question" onclick="finish({{ $index + 1 }})" style="display:none;">Finish</button>
                            @endif
        ...
        <div id="latest_score" class="mt-3" style="display: none">
